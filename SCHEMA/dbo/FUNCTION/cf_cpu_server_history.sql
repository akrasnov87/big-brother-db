CREATE OR REPLACE FUNCTION dbo.cf_cpu_server_history(_ip text) RETURNS TABLE(n_la1 numeric, n_la2 numeric, n_la3 numeric, dx_created timestamp with time zone)
    LANGUAGE plpgsql
    AS $$
/**
