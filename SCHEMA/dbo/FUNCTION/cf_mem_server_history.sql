CREATE OR REPLACE FUNCTION dbo.cf_mem_server_history(_ip text) RETURNS TABLE(n_mem_total numeric, n_mem_used numeric, dx_created timestamp with time zone)
    LANGUAGE plpgsql
    AS $$
/**
